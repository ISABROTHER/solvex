...
import { useAuth } from './AuthProvider'; // Corrected: Ensure this points to the file where useAuth is defined
import { Loader2, LogIn, UserPlus, Home } from 'lucide-react';
import AnimatedHomeButton from './AnimatedHomeButton'; // Corrected: Ensure this points to the button component file
