        ...
        try {
            ...
            if (error) {
                if (error.code === '23505') { // Handle unique email constraint
                     addToast({ type: 'error', title: 'Email already submitted', message: 'An access request with this email already exists.' });
                } else {
                    throw error;
                }
            } else {
            ...
            addToast({ type: 'error', title: 'Submission Error', message: error.message || 'Please try again.' });
        } finally {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
                ...
                <p className="text-center text-gray-500 mb-6 text-sm">Fill out the form for client portal access.</p>
