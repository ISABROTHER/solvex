...
return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-stone-50 via-orange-50 to-amber-50 items-center justify-center px-5 py-10 selection:bg-[#FF5722]/20">
        <motion.div
            ...
            className="w-full max-w-3xl bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 md:grid md:grid-cols-5"
        >
            {/* Left Side: Form (3 columns) */}
            <div className="p-6 sm:p-8 md:col-span-3">
                <div className="mb-8 text-center md:text-left">
                    <img src="/Solvexstudios logo.png" alt="Solvex Logo" className="h-10 w-auto mb-4 mx-auto md:mx-0" />
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Client Dashboard Access</h1>
                    ...
                    <div className="relative group">
                        <label htmlFor="reason" className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-1">
                            ...
                            <span className="relative ml-1 group/tooltip">
                                ...
                                <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-gray-700 text-white text-xs rounded opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none z-10">
                        ...
                        <textarea
                            ...
                            rows={4}
                            required
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF5722] focus:border-transparent transition duration-200 ease-in-out resize-none"
                        ></textarea>
                    </div>
                    {/* Submit Button */}
                    <div>
